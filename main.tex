...
\usepackage{cancel}
\usepackage{pgfplots}
\pgfplotsset{compat=1.18} % O una versione più recente se ce l'hai
...
\include{Capitoli/Errori-e-aritmetica-finita}
\include{Capitoli/Matlab}

\include{Capitoli/Radici-di-una-funzione}

\include{Capitoli/Sistemi-lineari-e-non-lineari}


\include{Capitoli/Approssimazione-di-funzioni}

\include{Capitoli/Formule-di-Quadratura}
